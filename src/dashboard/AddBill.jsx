    ...
    <div className="bg-white min-h-screen p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 border-b border-gray-200 pb-6">
          <h2 className="text-2xl font-bold text-gray-800">Configure Invoice</h2>
          <p className="text-gray-500">Define the structure of your billing table.</p>
        </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            <div>
              <h3 className="font-semibold text-gray-800 mb-4 flex items-center gap-2">
                {editingId ? <Save size={18} color={themeColor} /> : <Plus size={18} color={themeColor} />}
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    style={{ 
                      ...
                      borderColor: editingId ? themeColor : (newColName ? themeColor : '') 
                    }}
                  />
                </div>
                ...
                <div className="flex items-center justify-between bg-gray-50 p-3 rounded-lg border border-gray-200">
                  <div className="flex flex-col">
                    <span className="text-sm font-medium text-gray-700">Numerical?</span>
                    <span className="text-xs text-gray-500">Is this a number field?</span>
                  </div>
                  ...
                  <button
                    ...
                    style={{ backgroundColor: isNumeric ? themeColor : '#cbd5e1' }}
                  >
                    <span
                      className={`
          ...
          <div className="lg:col-span-8">
            <div className="h-full flex flex-col">
              <div className="flex items-center gap-2 text-gray-500 mb-4 border-b border-gray-200 pb-2">
                <Layout size={16} />
                <span className="text-sm font-medium uppercase tracking-wide">Table Structure Preview</span>
              </div>
              ...
              {columns.length === 0 ? (
                <div className="flex-1 border-2 border-dashed border-gray-200 rounded-xl flex flex-col items-center justify-center text-center p-10 text-gray-400 bg-gray-50/50">
                  ...
                  <p className="font-medium text-gray-600">No columns added yet</p>
                </div>
              ) : (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div 
                          ...
                          style={{ 
                            backgroundColor: editingId === col.id ? themeColor : '#f1f5f9', 
                            color: editingId === col.id ? '#fff' : '#64748b' 
                          }}
                        >
                          {col.isNumeric ? <Hash size={18} /> : <Type size={18} />}
                        </div>
                        
                        <div className="flex flex-col">
                          <span className={`font-semibold ${editingId === col.id ? 'text-[#7367f0]' : 'text-gray-700'}`}>
                            {col.name}
                          </span>
