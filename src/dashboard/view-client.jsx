    ...
    <div className="bg-gray-50 p-8 md:p-0">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold text-gray-800">View Client</h1>
          ...
          <div className="flex gap-3">
            {!isEditing ? (
              <>
                <button
                  onClick={handleEdit}
                  className="flex items-center gap-2 px-5 py-2 rounded-lg text-white font-medium shadow-sm transition active:scale-95"
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2 rounded-lg text-white font-medium bg-red-500 hover:bg-red-600 transition shadow-sm active:scale-95"
                >
                  <Trash2 size={16} />
                  Delete
                </button>
              ...
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2 rounded-lg border text-gray-700 hover:bg-gray-100 transition"
                >
                  <X size={16} />
                  Cancel
                </button>
